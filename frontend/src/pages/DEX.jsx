...
const DEX = () => {
  const { address, swap, getVBTCPrice, approveVBTC, approveVNST, claim, claimBNB } = useStateContext();
                ...
                <div className='mb-8 md:mb-3 p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-80 w-full my-3 eth-card white-glassmorphism'>
                  <div className='flex justify-between flex-col w-full h-full'>
                    ...
                    <div>
                      ...
                      <p className='text-white font-semibold text-lg mt-1'>Binance Smart Chain Testnet</p>
                    </div>
                  </div>
                </div>
                <w3m-button size='md' />
